        ...
        <section id="experience" className="relative z-30 py-64 overflow-hidden bg-black/40">
            ...
            <div className="container mx-auto px-10">
                <div className="text-center mb-40 space-y-8">
                    ...
                    <p className="text-white/30 font-poppins text-lg lg:text-2xl max-w-2xl mx-auto tracking-[0.3em] uppercase leading-relaxed font-medium">The heart of Inti Ruchi Bhojanam on your plate.</p>
                </div>
